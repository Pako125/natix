...
//
//   Original filename: natix/natix/SimilaritySearch/Result/Result.cs
// 
using System;
...
namespace natix.SimilaritySearch
{
	...
	public class Result : IResult
	{
		...
		/// <summary>
		/// If not null it is used to ensure uniqueness of docids
		/// </summary>
		HashSet<int> InsideUnique;
		/// <summary>
