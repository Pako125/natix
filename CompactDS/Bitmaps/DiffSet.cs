...
//
//   Original filename: natix/natix/CompactDS/Bitmaps/DiffSet.cs
// 
using System;
...
//				bool enabled = pos == found_pos;
//				rank = this.Rank1 (pos);
//				bool enabled_test = pos == this.Select1 (rank);
//				if (enabled != enabled_test) {
//					throw new Exception ("XXXXX ERROR ACCESS XXXX");
//				}
//				return enabled_test;
			}
		}
